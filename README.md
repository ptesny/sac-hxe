...
This ReadMe contains code and data for the **Getting Started with SAP HANA Express Edition and SAP Analytics Cloud** video series.  Please note that this page is subject to changes and additions.

[Click here to go to the playlist for this video series](https://www.youtube.com/playlist?list=PLkzo92owKnVxc5ywbnmPjmTPTUSZVlDIy) on the SAP HANA Academy YouTube channel.
...
3) [Data Download](#dd)
4) [HANA Data SQL](#hds)
5) [Additional HANA Code Snippets](#ahcs)
<br>
